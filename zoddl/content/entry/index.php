                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                    <div class="form-group">
                                        <form action="<?php echo base_url('entry/addmanual/'.$customerid); ?>" method="post" enctype="multipart/form-data" class="mt-repeater form-horizontal" id="addmanualentryform" novalidate="novalidate">

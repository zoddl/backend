						   ...
						   //print_r($response['request4']);
							...
							if($returnstatus == 1)
						    ...
						    else
						     {
								...
								($data->column1->Id == 'count' && in_array($data->column1->Id, $tagType) && $data->column3->Id == 'day') || 
								($data->column1->Id == 'count' && $data->column2->Id == 'day' && in_array($data->column1->Id, $tagType)) || 
								($data->column1->Id == 'day' && in_array($data->column1->Id, $tagType) && $data->column3->Id == 'count') || 
								($data->column1->Id == 'day' && $data->column2->Id == 'count' && in_array($data->column1->Id, $tagType)) )
						{

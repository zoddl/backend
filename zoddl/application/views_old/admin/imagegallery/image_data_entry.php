                                  ...
                                  <table class="table table-bordered">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                            ...
                                            <div class="form-group">
                                              <div class="input-icon">
                                              <input id = "pptagg" type="text" name="ptagsingle" class="form-control btn-sm" 
...
#country-list{float:left;list-style:none;margin-top:0px;padding:0;width:100%;position: absolute; z-index: 10;}
...
/**********Autocomplee code************/
   ...
   $("#pptagg").keyup(function(){
        
        var val = $(this).val();
        var cid = '<?php echo $tagData->Customer_Id; ?>';
        $.ajax({
        type: "POST",
        url: "<?php echo base_url('entry/getprimarytag' ); ?>",
        data:{ val: val, cid: cid},
        beforeSend: function(){
          $("#pptagg").css("background","#FFF url(LoaderIcon.gif) no-repeat 165px");
        },
        success: function(data){
          $("#suggesstion-box-p").show();
          $("#suggesstion-box-p").html(data);
          $("#pptagg").css("background","#FFF");
        }
        });
      });

   $("#pptagg").click(function(){

                       ...
                       <!--  <h1 class="page-title"> Add manual entry </h1> -->
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url('entry/index/'.$customerid);?>">Entry</a>
                                    <i class="fa fa-circle"></i>
                                </li>
                                <?php }  ?>
                                
                                <li>
                                    <span>Image Manual Entry</span>
                                </li>
                            </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-gift"></i><?php echo $page_title; ?> Image Manual Entry : User : <?php echo $customer; ?></div>                                
                            </div>
                            <div class="portlet-body form">
                                <div class="form-body">
                                    <div class="form-group">
                                        <form action="<?php echo base_url('entry/addmanual/'.$customerid); ?>" method="post" enctype="multipart/form-data" class="mt-repeater form-horizontal" id="addmanualentryform" novalidate="novalidate" autocomplete="off">
                                            ...
                                            <div data-repeater-list="group-a">
                                                ...
                                                <option value="4" <?php if( !empty($info->Tag_Status) &&  $info->Tag_Status == '4') { ?> selected="selected"<?php } ?>>Decline Blur</option>                       
                                                     ...
                                                     <div class="mt-repeater-input" >
                                                            <br>
                                                            <button class="btn btn-success mt-repeater-add" type="submit"> Add</button>
                                                             &nbsp;&nbsp;
                                                ...
                                                <div data-repeater-item="">
                                                   ...
                                                   <div class="mt-repeater-input">
                                                    ...
                                                    <div class="mt-repeater-input">
                                                     ...
                                                     <div class="mt-repeater-input">
                                                        <label class="controlCustomer_Id-label">Image(Please Upload : jpg, png, gif, jpeg formate.)</label>
                                                        <br>
                                                        <input type="file" name="file" class="form-control btn-sm" onchange="checkFile(this,this.id)" id="file" accept="image/*" />
                                                        </br>
                                                        <strong>Note:- Please upload image size maximum 4 mb.</strong> 
                                                    </div>
...
#country-list{float:left;list-style:none;margin-top:0px;padding:0;width:163px;position: absolute; z-index: 10;}
...
.error { color: red;}
        ...
        <script>
            var BASE_URL = '<?php echo base_url('entry/dataresult/'.$customerid); ?>';
        </script>
		...
		$(document).ready(function(){
			$("#Primary_Tag").keyup(function(){
				...
				$.ajax({
				type: "POST",
				url: "<?php echo base_url('entry/getprimarytag' ); ?>",
			...
			$("#Secondry_Tag").keyup(function(){
				...
				$.ajax({
				type: "POST",
				url: "<?php echo base_url('entry/getsecondarytag' ); ?>",
				data:{ val: val, cid: cid},
				beforeSend: function(){
...
<script>
        function checkFile(fieldObj,id)
            {
                ...
                if ( (FileExt == "pdf") && FileSize > 10485760)
                {   
                    document.getElementById(id).value = "";
                    alert("Please upload 10 mb maximum size");
                    return false;
                }
                if( (FileExt == "jpg" || FileExt == "jpeg" || FileExt == "png" || FileExt == "gif") && FileSize > 4194304)
                {
                    document.getElementById(id).value = "";
                     alert("Please upload 4 mb maximum size");  
                    return false;
                }
                return true;
            }

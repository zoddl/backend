                            ...
                            <div class="portlet-body form">
                                <div class="form-body">
                                    <div class="form-group">
                                        <form action="<?php echo base_url('entrydocument/addmanual/'.$customerid); ?>" method="post" enctype="multipart/form-data" class="mt-repeater form-horizontal" id="addmanualentryform" novalidate="novalidate"  autocomplete="off">
                                                ...
                                                <div data-repeater-item="">
                                                   ...
                                                   <div class="mt-repeater-input">
                                                    ...
                                                    <div class="mt-repeater-input">
                                                     ...
                                                     <div class="mt-repeater-input">
                                                        <label class="controlCustomer_Id-label">Document(Please Upload : doc, xls, pdf formate.)</label>
                                                        <br>
                                                        <input type="file" name="file" class="form-control btn-sm" id="file" onchange="checkFile(this,this.id)" />
                                                        </br>
                                                        <strong>Note:- Please upload document size maximum 8 mb.</strong>  
                                                    </div>
        ...
        function checkFile(fieldObj,id)
            {
                ...
                {   
                    ...
                    alert("Please upload 8 mb maximum size");
                    return false;
                }

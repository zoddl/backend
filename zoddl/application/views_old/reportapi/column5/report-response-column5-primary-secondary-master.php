...
<td>
    <?php
        ...
        else if(in_array($a, array('All')))
        {
            if(empty($request61->$a))
            {
               echo $request61->Tag_Type;
            }
            else
            {
        ...
        else if(in_array($a, array('Day')))
        {

            echo ucfirst($request61->Date);
        }
        else {

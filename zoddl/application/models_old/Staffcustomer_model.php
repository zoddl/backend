...
/**
* Staffcustomer_model Class
*
* @author Antaryami
* @created on 28-12-2017
* @version 1.0
* @description staff customer model written all business logics
* @link https://zoddl.com/
*/

class Staffcustomer_model extends CI_Model {
    ...
    */	
	...
	var $customertable = 'tbl_users';
	var $customercolumn = array('id','email');
	...
	public function get_datatables($searchkeyword = '')
		{
			...
			{	
				$where = "(name LIKE '%".$searchkeyword."%' OR email LIKE '%".$searchkeyword."%' OR phone_number LIKE '%".$searchkeyword."%')";
				$this->db->where($where);
			}

                            ...
                            <div class="col-md-12">
                                <div class="portlet light bordered">
                                                ...
                                                <div class="portlet-body form">
                                                    <!-- BEGIN FORM-->
                                                    <form class="form-horizontal" method="post" action="<?php echo base_url('customer/useredit_process/'.$usertypeid.'/'.$customerid);?>" enctype="multipart/form-data" id="form_sample_1">
                                                        ...
                                                        <div class="form-body">
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" name="email" class="form-control" value="<?php echo $customer->email; ?>" placeholder="Email" readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" name="phone_number" class="form-control" value="<?php echo $customer->phone_number; ?>" placeholder="Mobile">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" name="alt_phone_number" class="form-control" value="<?php echo $customer->alt_phone_number; ?>" placeholder="Alt Mobile">
                                                                </div>
                                                            </div>
                                                                        ...
                                                                        <?php
                                                                            if(!empty($country))
                                                                            {
                                                                                ...
                                                                                { ?>
                                                                                       ...
                                                                                       <option value="<?php echo $country->id; ?>" <?php if($customer->country == $country->id) echo "selected"; ?> ><?php echo $country->name; ?></option>
                                                                        ...
                                                                        <?php
                                                                            if(!empty($state))
                                                                            {
                                                                                ...
                                                                                { ?>
                                                                                       ...
                                                                                       <option value="<?php echo $state->id; ?>" <?php if($customer->state == $state->id) echo "selected"; ?> ><?php echo $state->name; ?></option>
                                                                        ...
                                                                        <?php
                                                                            if(!empty($city))
                                                                            {
                                                                                ...
                                                                                { ?>
                                                                                       ...
                                                                                       <option value="<?php echo $city->id; ?>" <?php if($customer->city == $city->id) echo "selected"; ?> ><?php echo $city->name; ?></option>

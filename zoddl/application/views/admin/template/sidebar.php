<?php               
    ...
    $imagetagQuery = $this->db->query("SELECT * FROM tbl_tag WHERE 1 = 1 AND (Tag_Type = '' or Tag_Send_Date = '' or Amount IS NULL or Primary_Tag = 0 )");
    ...
    $documenttagQuery = $this->db->query("SELECT * FROM tbl_doc_tag WHERE 1 = 1 AND (Tag_Type = '' or Tag_Send_Date = '' or Amount IS NULL or Primary_Tag = 0 )");

                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                 ...
                                 <li>
                                    ...
                                    <a href="<?php echo base_url('document/searchbyprimarytag/'.$usertypeid.'/'.$customerid.'/'.$primarytagid); ?>"><?php echo $Prime_Name; ?></a>
                                    <i class="fa fa-angle-right"></i>
                                </li>
            ...
            $(document).ready(function(){
                ...
                //$.noConflict();     
                      table = $('#example').DataTable({
                        ...
                        "ajax": {
                            "url": "<?php echo base_url('document/secondorytagviewdata/'.$usertypeid.'/'.$customerid.'/'.$secondorytagid.'/'.$primarytagid)?>",
                            "type": "POST"
                        },
                        "columnDefs": [
                        { 

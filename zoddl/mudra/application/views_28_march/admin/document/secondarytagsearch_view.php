 <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END THEME PANEL -->
                         <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Managed Secondary Tag Document Gallery </h1>
                        <!-- BEGIN PAGE BAR -->
                        <div class="page-bar">
            ...
            $(document).ready(function(){
                ...
                //$.noConflict();     
                      table = $('#example').DataTable({
                        ...
                        "ajax": {
                            "url": "<?php echo base_url('document/searchsecondarytagdocumentdata/'.$usertypeid.'/'.$customerid.'/'.$secondarytagid)?>",
                            "type": "POST"
                        },
                        "columnDefs": [
                        { 

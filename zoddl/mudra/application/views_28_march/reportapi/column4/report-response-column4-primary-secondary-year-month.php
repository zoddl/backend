...
<td><?php
    if(!empty($request5->Year) && !empty($request5->Month))
    {
        echo $request5->Year;
    }
    else if(!empty($request5->Year))
    {
        echo $request5->Year;

    }
     else if(!empty($request5->Month))
    {
        echo $request5->Month;
 ...
 <td><?php
    if(!empty($request5->Month) && !empty($request5->Year))
    {
        echo $request5->Month;
    }
    else if(!empty($request5->Amount))
    {

...
class Exportcsv extends CI_Controller
{
    ...
    public function export_csvStaff()
    {
        ...
        $sql = "SELECT Customer_Name,Email_Id,Phone_No,Alt_Phone_No,Facebook_Profile,Linked_In_Profile,Twitter_Handle,Aadhar_No,Skype_Id FROM `tbl_customer` WHERE `User_Type`='1'";
 ...
 /*********abhinav function to export Staff Users Excel**********/
      public function export_excelStaff()
    {
        ...
        $sql = "SELECT Id,Customer_Name,Email_Id,Phone_No,Alt_Phone_No,Facebook_Profile,Linked_In_Profile,Twitter_Handle,Aadhar_No,Skype_Id FROM `tbl_customer` WHERE `User_Type`='1'";
        $rs = $this->db->query($sql);
  ...
  /*********abhinav function to export General Users CSV**********/
    ...
    public function export_csvCompany()
    {
      date_default_timezone_set('Asia/calcutta');
        ...
        //retrive contries table data
        $sql = "SELECT Customer_Name,Email_Id,Phone_No,Alt_Phone_No,Facebook_Profile,Linked_In_Profile,Twitter_Handle,Aadhar_No,Skype_Id FROM `tbl_customer` WHERE `User_Type`='3'";
        $rs = $this->db->query($sql);
      ...
      public function export_excelCompany()
    {
        ...
        $sql = "SELECT Id,Customer_Name,Email_Id,Phone_No,Alt_Phone_No,Facebook_Profile,Linked_In_Profile,Twitter_Handle,Aadhar_No,Skype_Id FROM `tbl_customer` WHERE `User_Type`='3'";
        $rs = $this->db->query($sql);

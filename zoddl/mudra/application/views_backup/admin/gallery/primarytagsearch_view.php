 <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <!-- END THEME PANEL -->
                         <!-- BEGIN PAGE TITLE-->
                        <h1 class="page-title"> Managed Primary Tag Image Gallery </h1>
                        <!-- BEGIN PAGE BAR -->
                        <div class="page-bar">
            ...
            $(document).ready(function(){
                ...
                //$.noConflict();     
                      table = $('#example').DataTable({
                        ...
                        "ajax": {
                            "url": "<?php echo base_url('gallery/searchprimarytaggallerydata/'.$usertypeid.'/'.$customerid.'/'.$primarytagid)?>",
                            "type": "POST"
                        },
                        "columnDefs": [
                        { 

								 ...
								 <?php }?>
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" data-required="1" name="Customer_Name" class="form-control" value="<?php echo $customer->Customer_Name; ?>" placeholder="Full Name">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <input type="text" name="Email_Id" class="form-control" value="<?php echo $customer->Email_Id; ?>" placeholder="Email">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <select class="form-control" name="Paid_Status">
                                                                        ...
                                                                        <option value="2" <?php if($customer->Paid_Status == 2) echo "selected"; ?> >UnPaid</option>

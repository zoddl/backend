                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <?php
                                    ...
                                    { ?>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url('gallery/searchbysecondarytag/'.$usertypeid.'/'.$customerid.'/'.$secondarytagid); ?>"><?php echo $Secondary_Name; ?></a>
                                            <i class="fa fa-angle-right"></i>
                                        </li>
            ...
            $(document).ready(function(){
                ...
                //$.noConflict();     
                      table = $('#example').DataTable({
                        ...
                        "ajax": {
                            "url": "<?php echo base_url('gallery/primarytagviewdata/'.$usertypeid.'/'.$customerid.'/'.$primarytagid.'/'.$secondarytagid)?>",
                            "type": "POST"
                        },
                        "columnDefs": [
                        { 

var Login = function() {
    var e = function() {
			...
			$.ajax({
				...
				beforeSend : function(msg){ $("#submitbutton").html('<img src="<?php echo base_url('assets/backend/images/loading.gif'); ?>" />'); },
				success: function(msg)
				{
					...
					{
						$("#ajax").html(msg); 
						$("#submitbutton").html('<button type="submit" class="width-35 pull-right btn btn-sm btn-primary" data-style="expand-left"><i class="ace-icon fa fa-key"></i><span class="bigger-110">Login</span></button>');
					}
					else
					{ 
						$("#ajax").html(msg); 
